# https://github.com/Utkarsh87/md5-hashing
import math
...
constants = [
    int(abs(math.sin(i + 1)) * 4294967296) & 0xFFFFFFFF for i in range(64)
]
...
def processMessage(msg):
    ...
    return sum(
        buffer_content << (32 * i)
        for i, buffer_content in enumerate(init_temp)
    )
